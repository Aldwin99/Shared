package com.example.sharedpreferencies
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val switchUno = findViewById<Switch>(R.id.switch1)
        val switchDos = findViewById<Switch>(R.id.switch2)
        val switchTres = findViewById<Switch>(R.id.switch3)
        val switchCuatro = findViewById<Switch>(R.id.switch4)
